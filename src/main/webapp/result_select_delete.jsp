...
<body>
    ...
    <h3>削除結果</h3>
	    ...
	    <%
	    	...
	    	ArrayList<Apartment> deleteLists = (ArrayList<Apartment>) request.getAttribute("deleteLists");
	   	...
	   	%>
	   			...
	   			<p><%=result_status %></p>
	   	<%	    		
	    	}else if(result_status > deleteLists.size()){
	   	%>
	   			<p><%=result_status %></p>
	   			<p>予期せぬエラーが発生しました。</p>
